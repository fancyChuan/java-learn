...
import cn.fancychuan.spring.aop.aspectj.ICustomerBo;
import cn.fancychuan.spring.collections.Customers;
import cn.fancychuan.spring.helloworld.HelloWorld;
import cn.fancychuan.spring.innerbean.Customer;
import cn.fancychuan.spring.aop.advice.StudentService;
import cn.fancychuan.spring.innerbean.Person;
import cn.fancychuan.spring.loosely_coupled.OutputHelper;
...
public class Main {
    ...
    private static void testServices() {
        ...
        cn.fancychuan.spring.services.CustomerService singletonA = (cn.fancychuan.spring.services.CustomerService) context.getBean("services-singleton");
        singletonA.setMessage("[*]singleton message..");
        System.out.println(singletonA.getMessage());
        cn.fancychuan.spring.services.CustomerService singletonB = (cn.fancychuan.spring.services.CustomerService) context.getBean("services-singleton");
        System.out.println(singletonB.getMessage());

        // prototype 每次getbean都会新建一个实例
        cn.fancychuan.spring.services.CustomerService prototypeA = (cn.fancychuan.spring.services.CustomerService) context.getBean("services-prototype");
        prototypeA.setMessage("[x]prototype message..");
        System.out.println(prototypeA.getMessage());
        cn.fancychuan.spring.services.CustomerService prototypeB = (cn.fancychuan.spring.services.CustomerService) context.getBean("services-prototype");
    ...
    private static void testSpringAuto() {
        ...
        cn.fancychuan.spring.spring_auto.services.CustomerService cs = (cn.fancychuan.spring.spring_auto.services.CustomerService) context.getBean("customerService");
