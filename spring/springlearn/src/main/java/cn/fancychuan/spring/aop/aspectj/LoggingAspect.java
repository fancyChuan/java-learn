...
public class LoggingAspect {
    ...
    // execution是切入点表达式
    @Before("execution(public * cn.fancychuan.spring.aop.aspectj.CustomerBo.addCustomer(..))")
    // * 表示返回值类型
    ...
    @After("execution(public * cn.fancychuan.spring.aop.aspectj.CustomerBo.deleteCustomer(..))")
    ...
    @AfterReturning("cn.fancychuan.spring.aop.aspectj.PointcutsDefinition.custmerLog()")
